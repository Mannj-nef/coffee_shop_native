...
const BeansData: typeCoffe[] = [
  {
    ...
    imagelink_square: BEAN_IMAGE.ROBUSTA,
    imagelink_portrait: BEAN_IMAGE.ROBUSTA,
    ingredients: 'Africa',
  ...
  },
  {
    ...
    roasted: 'Medium Roasted',
    imagelink_square: BEAN_IMAGE.ARABICA,
    imagelink_portrait: BEAN_IMAGE.ARABICA,
    ingredients: 'Africa',
    special_ingredient: 'From Africa',
    prices: [
      { size: '250gm', price: '5.50', currency: '$' },
  ...
  },
  {
    ...
    roasted: 'Medium Roasted',
    imagelink_square: BEAN_IMAGE.NATIVE,
    imagelink_portrait: BEAN_IMAGE.NATIVE,
  ...
  },
  {
    ...
    roasted: 'Medium Roasted',
    imagelink_square: BEAN_IMAGE.EXCELSA,
    imagelink_portrait: BEAN_IMAGE.EXCELSA,
    ingredients: 'Malaysia',
    special_ingredient: 'From Malaysia',
    prices: [
      { size: '250gm', price: '5.50', currency: '$' },
